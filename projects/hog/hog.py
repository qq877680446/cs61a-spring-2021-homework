...
def more_boar(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    def to_2digits(score):
        while score >= 100:
            score //= 10
        return score
    player_score = to_2digits(player_score)
    opponent_score = to_2digits(opponent_score)
    ...
    while score0 < goal and score1 < goal :
        if who:
            ...
            if more_boar(score0, score1) == False:
                who = next_player(who)
        say = say(score0, score1)  # solution of PROBLEM 6
    # END PROBLEM 5
    # (note that the indentation for the problem 6 prompt (***YOUR CODE HERE***) might be misleading)
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"  # is line 157
    # END PROBLEM 6
    ...
    def say(score0, score1):
        ...
        if who:
            if score1 - last_score > running_high:
                rh = score1 - last_score
                print("Player", who, "has reached a new maximum point gain.", rh, "point(s)!")
        else:
            if score0 - last_score > running_high:
                rh = score0 - last_score
                print("Player", who, "has reached a new maximum point gain.", rh, "point(s)!")
        if who:
            return announce_highest(who, last_score = score1, running_high=rh)
        else:
            return announce_highest(who, last_score = score0, running_high=rh)
    return say
    # END PROBLEM 7
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return more_boar_strategy(score, opponent_score)  # Replace this statement
    # END PROBLEM 12
